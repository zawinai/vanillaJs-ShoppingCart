...
})({"lQrDW":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "0b6757383702e339";
"use strict";
...
},{}],"fiw1F":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Display", ()=>Display);
parcelHelpers.export(exports, "displayDetailModal", ()=>displayDetailModal);
parcelHelpers.export(exports, "addProductToCart", ()=>addProductToCart);
parcelHelpers.export(exports, "showProductsInCart", ()=>showProductsInCart);
parcelHelpers.export(exports, "clearCart", ()=>clearCart);
var _pricingJs = require("./pricing.js");
class Display {
    static displayProducts(products) {
        ...
        Array.from(breadCrumb.children).forEach((b)=>{
            b.addEventListener("click", (e)=>{
                Array.from(breadCrumb.children).map((c)=>{
                    c.dataset.option == e.target.dataset.option ? c.classList.add("select") : c.classList.remove("select");
                });
            });
        });
        if (products) products.map((p)=>{
        ...
        if (cards.length) require("ebfe2527e3a2fef5").then(({ Store  })=>{
            ...
            if (cartItems.length >= 1) {
                ...
                (0, _pricingJs.calculateTotal)();
            }
        });
    }
}
function displayDetailModal(products) {
...
function addProductToCart(cartList) {
    ...
    addToCartBtn.addEventListener("click", (e)=>{
        ...
        if (target.dataset.id) require("27b4ba360f182fe4").then(({ FetchData  })=>{
            FetchData.getData().then((data)=>{
                let found = data.find((p)=>p.id === parseInt(target.dataset.id));
                if (cartList) {
                    require("ebfe2527e3a2fef5").then(({ Store  })=>{
                        require("f44d3b04de94b046").then(({ calculateTotal  })=>{
                            calculateTotal();
                        });
                        cartList = [
                    ...
                    require("f44d3b04de94b046").then(({ handleQty  })=>{
...
function showProductsInCart() {
    ...
    if (cards.length) {
        ...
        require("ebfe2527e3a2fef5").then(({ Store  })=>{
            ...
            } else cartTitle.textContent = "Empty Cart";
        });
    }
}
function clearCart(parent) {
    Array.from(parent.children).forEach((n)=>{
        n.remove();
    });
}

},{"./pricing.js":"3KT9R","ebfe2527e3a2fef5":"cKJTC","27b4ba360f182fe4":"1W6LB","f44d3b04de94b046":"lpcKf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3KT9R":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "calculateTotal", ()=>calculateTotal);
parcelHelpers.export(exports, "handleQty", ()=>handleQty);
parcelHelpers.export(exports, "checkOut", ()=>checkOut);
function calculateTotal() {
    require("32c88448c2d9b85a").then(({ Store  })=>{
        ...
        const totalPrice = cartItems.map((c)=>c.price * c.quantity).reduce((prev, curr)=>{
            return prev + curr;
        }, 0);
        const totalQty = cartItems.map((c)=>c.quantity).reduce((prev, curr)=>{
            return prev + curr;
        }, 0);
...
function handleQty(e) {
    require("32c88448c2d9b85a").then(({ Store  })=>{
        ...
        if (e.target.dataset.qty === "increase") {
            newCartList = Store.getCartProducts().map((s)=>s.id === check.id ? {
                    ...s,
                    quantity: s.quantity === 10 ? s.quantity = 10 : s.quantity + 1
                } : s);
            ...
            const checkCartList = Store.getCartProducts().map((s)=>s.id === check.id ? {
                    ...s,
                    quantity: s.quantity - 1
                } : s).find((f)=>f.quantity < 1);
            newCartList = Store.getCartProducts().map((s)=>s.id === check.id ? {
                    ...s,
                    quantity: s.quantity - 1
                } : s).filter((f)=>f.quantity >= 1);
            if (checkCartList && checkCartList.id === parseInt(e.target.parentElement.dataset.id)) {
                ...
                cards.forEach((c)=>{
                    if (c.firstElementChild.dataset.id == e.target.parentElement.dataset.id) c.firstElementChild.removeChild(c.getElementsByClassName("incart-label")[0]);
                });
            } else e.target.previousElementSibling.innerText = newCartList.find((f)=>f.id === parseInt(e.target.parentElement.dataset.id)).quantity;
        }
        const qtyIcon = document.querySelector("[data-cart-icon-quantiy]");
        qtyIcon.classList.add("qty");
...
},{"32c88448c2d9b85a":"cKJTC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cKJTC":[function(require,module,exports) {
module.exports = require("./helpers/browser/js-loader")(require("./helpers/bundle-url").getBundleURL("YHuxh") + "storeData.f86c63a7.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("84opH"));
...
},{}],"1W6LB":[function(require,module,exports) {
module.exports = require("./helpers/browser/js-loader")(require("./helpers/bundle-url").getBundleURL("YHuxh") + "fetchData.b3d9f8cb.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("1cWrb"));

},{"./helpers/browser/js-loader":"61B45","./helpers/bundle-url":"lgJ39"}],"lpcKf":[function(require,module,exports) {
module.exports = Promise.resolve(module.bundle.root("3KT9R"));

},{}]},["lQrDW"], null, "parcelRequirecc01")

//# sourceMappingURL=display.3702e339.js.map
